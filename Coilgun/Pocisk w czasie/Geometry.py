...
def create_coilgun_geometry(r_tube, R_coil, H_coil, R_el, H_el, H0_el, R_BC, I_current, N_wire, freq):
    """
    ...
    f.mi_setblockprop("Ideal_Iron", 1, 0, "", 0, 5)
    f.mi_clearselected()
    ...
    f.mi_setblockprop("Air", 1, 0, "", 0, 0, 0)
    f.mi_clearselected()
